        ...
        <div class="container">
            ...
            <div class="row">
                ...
                {{-- <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/Laptop.png" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/Tablet.png" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/Dongho.png" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/Chuot.png" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/Phim.png" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/Sac.png" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/Manhinh.png" alt="IMG-BANNER">
